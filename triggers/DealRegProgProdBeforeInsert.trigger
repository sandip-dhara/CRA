/**
* Trigger Name: DealRegAllProductElligibleFlag
* Author: HP
* Date: 08-Oct-2012 
* Requirement # Request Id: 3396
* Description: To check if there are Program product Association already present in the database
*/
trigger DealRegProgProdBeforeInsert on Program_Product_Association__c (before insert) {
Global_Config__c globalConfig = Global_Config__c.getInstance(); 
    ...
    progProdAssociation.progProductRecordBeforeInsert(trigger.new);
    }