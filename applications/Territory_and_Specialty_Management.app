...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Admin console for managing Sales Territory Groups and Specialties</description>
    <label>Territory and Specialty  Management</label>
    <tab>standard-Contact</tab>
    <tab>standard-Account</tab>
    <tab>standard-Opportunity</tab>
    <tab>Product_Specialty__c</tab>
    <tab>Sales_Territory__c</tab>
    <tab>Batch_Job_Invoker__c</tab>
